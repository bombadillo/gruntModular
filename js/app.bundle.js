...
/**
 *  Name      search - Called using collection.search(). 
 *  Purpose   Extend the Backbone Collection object by adding search function to search collection 
 *            and return basic collection.
 *  Params    {object}    Contains the search query.
 */
Backbone.Collection.prototype.search = function(opts)
{
        var result = this.where( opts );
        var resultCollection = new BasicCollection( result );
...
__p+='<h1>Hello, '+
((__t=( name ))==null?'':__t)+
'!</h1><p>This is a template for a simple marketing or informational website. It includes a large callout called a jumbotron and three supporting pieces of content. Use it as a starting point to create something more unique.</p><p><a role="button" class="btn btn-primary btn-lg" href="#">Learn more »</a></p>';
}
return __p;
};
